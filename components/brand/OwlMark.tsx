...
export function OwlMark({ className, blink = true, sleepy = false, title = "S.OWL 부엉이" }: Props) {
  return (
    <svg viewBox="0 0 120 120" className={cn("block", className)} role="img" aria-label={title}>
      ...
      {/* 귀깃 */}
      <path d="M22 30 L34 6 L46 28 Z" fill="#1e2a52" stroke="#22d3ee" strokeOpacity=".35" strokeWidth="1.5" />
      <path d="M98 30 L86 6 L74 28 Z" fill="#1e2a52" stroke="#22d3ee" strokeOpacity=".35" strokeWidth="1.5" />
      {/* 몸통 */}
      <path
      ...
      />
      {/* 가슴 무늬 (터미널 프롬프트) */}
      <path d="M46 88 l8 6 -8 6" fill="none" stroke="#22d3ee" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" opacity=".75" />
      <rect x="58" y="97" width="16" height="3.5" rx="1.5" fill="#22d3ee" opacity=".75" />
      {/* 눈 */}
      <g>
        <circle cx="41" cy="54" r="19" fill="#070b18" stroke="#ffb020" strokeOpacity=".5" strokeWidth="2" />
        <circle cx="79" cy="54" r="19" fill="#070b18" stroke="#ffb020" strokeOpacity=".5" strokeWidth="2" />
        {sleepy ? (
          ...
          >
            ...
            <circle cx="41" cy="54" r="5.5" fill="#070b18" />
            <circle cx="79" cy="54" r="5.5" fill="#070b18" />
