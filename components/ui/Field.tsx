  ...
  return (
    <label className={cn("block", className)}>
      ...
      <input
        {...props}
        className={cn(
          "min-h-12 w-full rounded-2xl border border-line bg-night/70 px-4 text-[15px] text-ink outline-none transition-colors",
          "placeholder:text-dim focus:border-aqua/60 focus:bg-night",
...
export function TerminalCard({
  ...
  return (
    <div className={cn("card-solid overflow-hidden p-0", className)}>
      <div className="flex items-center gap-2 border-b border-line bg-night/60 px-4 py-2.5">
